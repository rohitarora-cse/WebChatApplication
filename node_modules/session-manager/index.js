var sessionManager = function(spec) {
	...
	var that = {};
         ...
         */
        that.getSession = function(request, response, createNewSession) {
        	createNewSession = typeof createNewSession === 'undefined' ? true : createNewSession; 
            var requestSession = {};
            ...
            if ('string' === typeof cookies[sessionManager.sessionIDCookieName]) {
                    ...
                    if(!engine.isSessionPresent(session_id)) {
                    	session_id = null;
                    }
            }
            if(session_id == null) {
	            if (!createNewSession) {
	            	return null;
	                    ...
	                    session_id = (Date.now().toString() + (Math.random()*100).toString()).replace('.', '');
            ...
            requestSession.destroySession = function() {
